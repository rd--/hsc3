...
>     ;f = demandEnvGen AR l y EnvExp 0 1 1 1 0 1 DoNothing}
...
>         ;f = demandEnvGen AR l (t * y) EnvCub 0 1 1 1 0 1 DoNothing}
...
>     ;f = demandEnvGen KR s 2 EnvLin 0 1 1 1 0 1 RemoveSynth}
> in audition (out 0 (sinOsc AR (f * mce2 1 1.01) 0 * 0.1))
