...
>         p = envASR 0.01 1 1 (dup2 (EnvNum (-4)))
...
> e_01 =
>     [envASR 0.1 1 1 (dup2 (EnvNum (-4)))
>     ,envASR 0.3 0.25 1 (dup2 EnvSin)
>     ,envASR 0.01 0.5 1.25 (dup2 EnvLin)]
...
> e_02 = envASR 0.01 1 0.75 (EnvNum (-4),EnvNum 4)
> e_03 = envASR 0.15 1 1.25 (EnvNum (-4),EnvNum (-4))
> e_04 = envASR 0.15 1 1.25 (EnvNum (-4),EnvNum 64)
