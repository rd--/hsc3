...
> plot_ugen1 0.1 (lfGauss AR 0.1 0.12 0 Loop DoNothing)

shifting left

> plot_ugen1 0.1 (lfGauss AR 0.1 0.12 (-1) NoLoop DoNothing)

moving further away from the center

> plot_ugen1 0.1 (lfGauss AR 0.1 0.12 2 Loop DoNothing)

several grains

> plot_ugen1 0.3 (lfGauss AR 0.065 0.12 0 Loop DoNothing)
