...
>       c3 = 20
>       pan = 0
>       e = Envelope [0,1,1,0] [0.001,0.006,0.0005] (map EnvNum [5,-5,-8]) Nothing Nothing
>       i = amp * lfClipNoise 'α' AR 2000 * envGen AR gate_ 1 0 1 DoNothing e
>       s = dWGPlucked2 AR freq amp gate_ 0.1 1 c3 i 0.1 1.008 0.55 0.01
>       z = detectSilence s 0.001 0.1 RemoveSynth
>   in mrg2 (pan2 s pan 0.1) z
