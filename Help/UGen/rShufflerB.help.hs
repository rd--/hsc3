...
-- rShufflerB ; controls
let b = control_md KR "buf" 0 (0,10,"lin",1,"")
...
in rShufflerB_grp b
   (k2 "loc" (0.0,0.5) (0,1,"lin",0,""))
   (k2 "incr" (1.99975,2.00025) (0.25,4,"lin",0,""))
   (k2_mul 0.001 (k2 "dur" (250,300) (0.01,500,"lin",0,"ms")))
   (k2 "amp" (0.8,0.9) (0.5,1.0,"amp",0,""))
   (k2 "shape" (0.5,0.6) (0,1,"lin",0,""))
   (k2 "skew" (0.4,0.6) (0,1,"lin",0,""))
   (k2 "pan" (0.0,1.0) (0,1,"lin",0,"")) -- ie. not (-1,1)
   (k2_mul 0.001 (k2 "iot" (50,52.5) (0.001,250,"lin",0,"ms")))
   (k "locIncr" 1.0 (0.25,4.0,"lin",0,""))
   (k "incrQ" 0.0 (0,1,"lin",0,""))
   (k "iotQ" 0.0 (0,1,"lin",0,""))
