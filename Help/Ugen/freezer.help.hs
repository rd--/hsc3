...
let b = control kr "buf" 100
in X.freezer b 0.35 0.4 0.6 0.1 0.05 0.02 0.1 0 0 6

-- freezer ; static instance
let b = control kr "buf" 100
in X.freezer b 0.3 0.4 0.6 1 0 0 0 0 0 6

-- freezer ; static instance
let b = control kr "buf" 100
in X.freezer b 0.3 0.7 0.6 0.35 0 0.5 0.5 0 0 6

-- freezer ; static instance
let b = control kr "buf" 100
in X.freezer b 0.2500 0.2505 0.1 1 0 0.050 0.005 0 0 24
...
in X.freezer b (nId 'α' 0.3 0.4) (nId 'β' 0.5 0.6) (nId 'γ' 0.3 0.6) (nId 'δ' 0.95 1.05) (nId 'ε' 0.05 0.15) (nId 'ζ' 0.05 0.15) (nId 'η' 0.05 0.15) 0 0 36

-- freezer ; controls
let b = control_m kr "buf" 100 (0,0,"lin")
