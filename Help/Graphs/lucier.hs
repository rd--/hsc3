...
lucier_wire freq =
	...
	drv = localIn 1 AR -- driver (source + what has been stored in the string)
	pk1_R = let i = drv
                    r = src_pos - pk1_pos
                in mk_delay i r
	pk1_L = let i = pk1_R * negate 1
                    r = pk1_pos * 2
	...
	stringR = let i = pk2_R
                      r = pk2_pos - src_pos
                  in mk_delay i r
	source = let s = sinOsc AR 220 0 * 0.01
