...
b_write :: Packet Message -> Int -> String -> SoundFileFormat -> SampleFormat -> Int -> Int -> Bool -> Message
...
b_zero :: Packet Message -> Int -> Message
