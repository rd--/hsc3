...
synthdefGraph = Graph.ugen_to_graph . synthdefUgen
...
synthdef_to_graphdef (Synthdef nm u) = Graphdef.Graph.graph_to_graphdef nm (Graph.ugen_to_graph u)
...
synthdefData = Graphdef.Binary.encode_graphdef . synthdef_to_graphdef
...
synthstat_ln = Graph.ug_stat_ln . Graph.ugen_to_graph
