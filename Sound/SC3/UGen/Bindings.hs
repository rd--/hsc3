...
a2K :: UGen -> UGen
a2K in_ = mkUGen Nothing [KR,KR] (Left KR) "A2K" [in_] Nothing 1 (Special 0) NoId

-- | FIXME: APF purpose.
apf :: UGen -> UGen -> UGen -> UGen
apf in_ freq radius = mkUGen Nothing [AR,KR] (Right [0]) "APF" [in_,freq,radius] Nothing 1 (Special 0) NoId

-- | All pass delay line with cubic interpolation.
allpassC :: UGen -> UGen -> UGen -> UGen -> UGen
allpassC in_ maxdelaytime delaytime decaytime = mkUGen Nothing [AR,KR] (Right [0]) "AllpassC" [in_,maxdelaytime,delaytime,decaytime] Nothing 1 (Special 0) NoId

-- | All pass delay line with linear interpolation.
allpassL :: UGen -> UGen -> UGen -> UGen -> UGen
allpassL in_ maxdelaytime delaytime decaytime = mkUGen Nothing [AR,KR] (Right [0]) "AllpassL" [in_,maxdelaytime,delaytime,decaytime] Nothing 1 (Special 0) NoId

-- | All pass delay line with no interpolation.
allpassN :: UGen -> UGen -> UGen -> UGen -> UGen
allpassN in_ maxdelaytime delaytime decaytime = mkUGen Nothing [AR,KR] (Right [0]) "AllpassN" [in_,maxdelaytime,delaytime,decaytime] Nothing 1 (Special 0) NoId

-- | Basic psychoacoustic amplitude compensation.
ampComp :: Rate -> UGen -> UGen -> UGen -> UGen
ampComp rate freq root exp_ = mkUGen Nothing [AR,KR,IR] (Left rate) "AmpComp" [freq,root,exp_] Nothing 1 (Special 0) NoId

-- | Basic psychoacoustic amplitude compensation (ANSI A-weighting curve).
ampCompA :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen
ampCompA rate freq root minAmp rootAmp = mkUGen Nothing [AR,KR,IR] (Left rate) "AmpCompA" [freq,root,minAmp,rootAmp] Nothing 1 (Special 0) NoId

-- | Amplitude follower
amplitude :: Rate -> UGen -> UGen -> UGen -> UGen
amplitude rate in_ attackTime releaseTime = mkUGen Nothing [AR,KR] (Left rate) "Amplitude" [in_,attackTime,releaseTime] Nothing 1 (Special 0) NoId
...
brf in_ freq rq = mkUGen Nothing [AR,KR] (Right [0]) "BRF" [in_,freq,rq] Nothing 1 (Special 0) NoId

-- | Two zero fixed midcut.
bRZ2 :: UGen -> UGen
bRZ2 in_ = mkUGen Nothing [AR,KR] (Right [0]) "BRZ2" [in_] Nothing 1 (Special 0) NoId

-- | Stereo signal balancer
balance2 :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen
balance2 rate left right pos level = mkUGen Nothing [AR,KR] (Left rate) "Balance2" [left,right,pos,level] Nothing 2 (Special 0) NoId

-- | physical model of bouncing object
ball :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen
ball rate in_ g damp friction = mkUGen Nothing [AR,KR] (Left rate) "Ball" [in_,g,damp,friction] Nothing 1 (Special 0) NoId
...
biPanB2 rate inA inB azimuth gain = mkUGen Nothing [AR,KR] (Left rate) "BiPanB2" [inA,inB,azimuth,gain] Nothing 3 (Special 0) NoId
...
blip rate freq numharm = mkUGen Nothing [AR,KR] (Left rate) "Blip" [freq,numharm] Nothing 1 (Special 0) NoId
...
brownNoise z rate = mkUGen Nothing [AR,KR] (Left rate) "BrownNoise" [] Nothing 1 (Special 0) (toUId z)
...
bufChannels rate bufnum = mkUGen Nothing [KR,IR] (Left rate) "BufChannels" [bufnum] Nothing 1 (Special 0) NoId
...
bufDelayC rate buf in_ delaytime = mkUGen Nothing [AR,KR] (Left rate) "BufDelayC" [buf,in_,delaytime] Nothing 1 (Special 0) NoId

-- | Buffer based simple delay line with linear interpolation.
bufDelayL :: Rate -> UGen -> UGen -> UGen -> UGen
bufDelayL rate buf in_ delaytime = mkUGen Nothing [AR,KR] (Left rate) "BufDelayL" [buf,in_,delaytime] Nothing 1 (Special 0) NoId

-- | Buffer based simple delay line with no interpolation.
bufDelayN :: Rate -> UGen -> UGen -> UGen -> UGen
bufDelayN rate buf in_ delaytime = mkUGen Nothing [AR,KR] (Left rate) "BufDelayN" [buf,in_,delaytime] Nothing 1 (Special 0) NoId

-- | Current duration of soundfile in buffer.
bufDur :: Rate -> UGen -> UGen
bufDur rate bufnum = mkUGen Nothing [KR,IR] (Left rate) "BufDur" [bufnum] Nothing 1 (Special 0) NoId

-- | Current number of frames allocated in the buffer.
bufFrames :: Rate -> UGen -> UGen
bufFrames rate bufnum = mkUGen Nothing [KR,IR] (Left rate) "BufFrames" [bufnum] Nothing 1 (Special 0) NoId

-- | Buffer rate scaling in respect to server samplerate.
bufRateScale :: Rate -> UGen -> UGen
bufRateScale rate bufnum = mkUGen Nothing [KR,IR] (Left rate) "BufRateScale" [bufnum] Nothing 1 (Special 0) NoId

-- | Buffer reading oscillator.
bufRd :: Int -> Rate -> UGen -> UGen -> Loop -> Interpolation -> UGen
bufRd numChannels rate bufnum phase loop interpolation = mkUGen Nothing [AR,KR] (Left rate) "BufRd" [bufnum,phase,(from_loop loop),(from_interpolation interpolation)] Nothing numChannels (Special 0) NoId

-- | Buffer sample rate.
bufSampleRate :: Rate -> UGen -> UGen
bufSampleRate rate bufnum = mkUGen Nothing [KR,IR] (Left rate) "BufSampleRate" [bufnum] Nothing 1 (Special 0) NoId

-- | Current number of samples in buffer.
bufSamples :: Rate -> UGen -> UGen
bufSamples rate bufnum = mkUGen Nothing [KR,IR] (Left rate) "BufSamples" [bufnum] Nothing 1 (Special 0) NoId

-- | Buffer writing oscillator.
bufWr :: Rate -> UGen -> UGen -> Loop -> UGen -> UGen
bufWr rate loop inputArray bufnum phase = mkUGen Nothing [AR,KR] (Left rate) "BufWr" [loop,inputArray,(from_loop bufnum)] (Just phase) 1 (Special 0) NoId

-- | Chorusing wavetable oscillator.
cOsc :: Rate -> UGen -> UGen -> UGen -> UGen
cOsc rate bufnum freq beats = mkUGen Nothing [AR,KR] (Left rate) "COsc" [bufnum,freq,beats] Nothing 1 (Special 0) NoId

-- | Test for infinity, not-a-number, and denormals
checkBadValues :: UGen -> UGen -> UGen -> UGen
checkBadValues in_ id_ post = mkUGen Nothing [AR,KR] (Right [0]) "CheckBadValues" [in_,id_,post] Nothing 1 (Special 0) NoId

-- | Clip a signal outside given thresholds.
clip :: UGen -> UGen -> UGen -> UGen
clip in_ lo hi = mkUGen Nothing [AR,KR,IR] (Right [0]) "Clip" [in_,lo,hi] Nothing 1 (Special 0) NoId

-- | Clip Noise.
clipNoise :: ID a => a -> Rate -> UGen
clipNoise z rate = mkUGen Nothing [AR,KR] (Left rate) "ClipNoise" [] Nothing 1 (Special 0) (toUId z)

-- | Statistical gate.
coinGate :: ID a => a -> UGen -> UGen -> UGen
coinGate z prob in_ = mkUGen Nothing [AR,KR] (Right [1]) "CoinGate" [prob,in_] Nothing 1 (Special 0) (toUId z)

-- | Comb delay line with cubic interpolation.
combC :: UGen -> UGen -> UGen -> UGen -> UGen
combC in_ maxdelaytime delaytime decaytime = mkUGen Nothing [AR,KR] (Right [0]) "CombC" [in_,maxdelaytime,delaytime,decaytime] Nothing 1 (Special 0) NoId

-- | Comb delay line with linear interpolation.
combL :: UGen -> UGen -> UGen -> UGen -> UGen
combL in_ maxdelaytime delaytime decaytime = mkUGen Nothing [AR,KR] (Right [0]) "CombL" [in_,maxdelaytime,delaytime,decaytime] Nothing 1 (Special 0) NoId

-- | Comb delay line with no interpolation.
combN :: UGen -> UGen -> UGen -> UGen -> UGen
combN in_ maxdelaytime delaytime decaytime = mkUGen Nothing [AR,KR] (Right [0]) "CombN" [in_,maxdelaytime,delaytime,decaytime] Nothing 1 (Special 0) NoId
...
controlDur :: UGen
controlDur = mkUGen Nothing [IR,IR] (Left IR) "ControlDur" [] Nothing 1 (Special 0) NoId

-- | Server control rate.
controlRate :: UGen
controlRate = mkUGen Nothing [IR,IR] (Left IR) "ControlRate" [] Nothing 1 (Special 0) NoId
...
convolution3 rate in_ kernel trigger framesize = mkUGen Nothing [AR,KR] (Left rate) "Convolution3" [in_,kernel,trigger,framesize] Nothing 1 (Special 0) NoId

-- | Chaotic noise function.
crackle :: Rate -> UGen -> UGen
crackle rate chaosParam = mkUGen Nothing [AR,KR] (Left rate) "Crackle" [chaosParam] Nothing 1 (Special 0) NoId
...
dc :: Rate -> UGen -> UGen
dc rate in_ = mkUGen Nothing [AR,KR] (Left rate) "DC" [in_] Nothing 1 (Special 0) NoId

-- | Demand rate brownian movement generator.
dbrown :: ID a => a -> UGen -> UGen -> UGen -> UGen -> UGen
dbrown z hi step length_ lo = mkUGen Nothing [DR,DR] (Left DR) "Dbrown" [hi,step,length_,lo] Nothing 1 (Special 0) (toUId z)

-- | Buffer read demand ugen
dbufrd :: ID a => a -> UGen -> UGen -> Loop -> UGen
dbufrd z bufnum phase loop = mkUGen Nothing [DR,DR] (Left DR) "Dbufrd" [bufnum,phase,(from_loop loop)] Nothing 1 (Special 0) (toUId z)

-- | Buffer write demand ugen
dbufwr :: ID a => a -> UGen -> UGen -> UGen -> Loop -> UGen
dbufwr z bufnum phase input loop = mkUGen Nothing [DR,DR] (Left DR) "Dbufwr" [bufnum,phase,input,(from_loop loop)] Nothing 1 (Special 0) (toUId z)

-- | Exponential decay
decay :: UGen -> UGen -> UGen
decay in_ decayTime = mkUGen Nothing [AR,KR] (Right [0]) "Decay" [in_,decayTime] Nothing 1 (Special 0) NoId

-- | Exponential decay
decay2 :: UGen -> UGen -> UGen -> UGen
decay2 in_ attackTime decayTime = mkUGen Nothing [AR,KR] (Right [0]) "Decay2" [in_,attackTime,decayTime] Nothing 1 (Special 0) NoId

-- | 2D Ambisonic B-format decoder.
decodeB2 :: Int -> Rate -> UGen -> UGen -> UGen -> UGen -> UGen
decodeB2 numChannels rate w x y orientation = mkUGen Nothing [AR,KR] (Left rate) "DecodeB2" [w,x,y,orientation] Nothing numChannels (Special 0) NoId

-- | Convert signal to modal pitch.
degreeToKey :: UGen -> UGen -> UGen -> UGen
degreeToKey bufnum in_ octave = mkUGen Nothing [AR,KR] (Right [1]) "DegreeToKey" [bufnum,in_,octave] Nothing 1 (Special 0) NoId

-- | Tap a delay line from a DelTapWr UGen
delTapRd :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen
delTapRd rate buffer phase delTime interp = mkUGen Nothing [AR,KR] (Left rate) "DelTapRd" [buffer,phase,delTime,interp] Nothing 1 (Special 0) NoId

-- | Write to a buffer for a DelTapRd UGen
delTapWr :: Rate -> UGen -> UGen -> UGen
delTapWr rate buffer in_ = mkUGen Nothing [AR,KR] (Left rate) "DelTapWr" [buffer,in_] Nothing 1 (Special 0) NoId

-- | Single sample delay.
delay1 :: UGen -> UGen
delay1 in_ = mkUGen Nothing [AR,KR] (Right [0]) "Delay1" [in_] Nothing 1 (Special 0) NoId

-- | Two sample delay.
delay2 :: UGen -> UGen
delay2 in_ = mkUGen Nothing [AR,KR] (Right [0]) "Delay2" [in_] Nothing 1 (Special 0) NoId

-- | Simple delay line with cubic interpolation.
delayC :: UGen -> UGen -> UGen -> UGen
delayC in_ maxdelaytime delaytime = mkUGen Nothing [AR,KR] (Right [0]) "DelayC" [in_,maxdelaytime,delaytime] Nothing 1 (Special 0) NoId

-- | Simple delay line with linear interpolation.
delayL :: UGen -> UGen -> UGen -> UGen
delayL in_ maxdelaytime delaytime = mkUGen Nothing [AR,KR] (Right [0]) "DelayL" [in_,maxdelaytime,delaytime] Nothing 1 (Special 0) NoId

-- | Simple delay line with no interpolation.
delayN :: UGen -> UGen -> UGen -> UGen
delayN in_ maxdelaytime delaytime = mkUGen Nothing [AR,KR] (Right [0]) "DelayN" [in_,maxdelaytime,delaytime] Nothing 1 (Special 0) NoId

-- | Demand results from demand rate UGens.
demand :: UGen -> UGen -> UGen -> UGen
demand trig_ reset demandUGens = mkUGen Nothing [AR,KR] (Right [0]) "Demand" [trig_,reset] (Just demandUGens) (length (mceChannels demandUGens) + 0) (Special 0) NoId
...
dgeom z length_ start grow = mkUGen Nothing [DR,DR] (Left DR) "Dgeom" [length_,start,grow] Nothing 1 (Special 0) (toUId z)

-- | Demand rate brownian movement generator.
dibrown :: ID a => a -> UGen -> UGen -> UGen -> UGen -> UGen
dibrown z hi step length_ lo = mkUGen Nothing [DR,DR] (Left DR) "Dibrown" [hi,step,length_,lo] Nothing 1 (Special 0) (toUId z)

-- | Stream in audio from a file.
diskIn :: Int -> Rate -> UGen -> Loop -> UGen
diskIn numChannels rate bufnum loop = mkUGen Nothing [AR] (Left rate) "DiskIn" [bufnum,(from_loop loop)] Nothing numChannels (Special 0) NoId

-- | Record to a soundfile to disk.
diskOut :: UGen -> UGen -> UGen
diskOut bufnum input = mkUGen Nothing [AR,AR] (Left AR) "DiskOut" [bufnum] (Just input) 1 (Special 0) NoId

-- | Demand rate white noise random generator.
diwhite :: ID a => a -> UGen -> UGen -> UGen -> UGen
diwhite z length_ lo hi = mkUGen Nothing [DR,DR] (Left DR) "Diwhite" [length_,lo,hi] Nothing 1 (Special 0) (toUId z)

-- | (Undocumented class)
donce :: ID a => a -> UGen -> UGen
donce z in_ = mkUGen Nothing [DR,DR] (Left DR) "Donce" [in_] Nothing 1 (Special 0) (toUId z)
...
dpoll z in_ label_ run trigid = mkUGen Nothing [DR,DR] (Left DR) "Dpoll" [in_,label_,run,trigid] Nothing 1 (Special 0) (toUId z)

-- | Demand rate random sequence generator.
drand :: ID a => a -> UGen -> UGen -> UGen
drand z repeats list_ = mkUGen Nothing [DR,DR] (Left DR) "Drand" [repeats] (Just list_) 1 (Special 0) (toUId z)

-- | demand rate reset
dreset :: ID a => a -> UGen -> UGen -> UGen
dreset z in_ reset = mkUGen Nothing [DR,DR] (Left DR) "Dreset" [in_,reset] Nothing 1 (Special 0) (toUId z)

-- | Demand rate sequence generator.
dseq :: ID a => a -> UGen -> UGen -> UGen
dseq z repeats list_ = mkUGen Nothing [DR,DR] (Left DR) "Dseq" [repeats] (Just list_) 1 (Special 0) (toUId z)

-- | Demand rate sequence generator.
dser :: ID a => a -> UGen -> UGen -> UGen
dser z repeats list_ = mkUGen Nothing [DR,DR] (Left DR) "Dser" [repeats] (Just list_) 1 (Special 0) (toUId z)

-- | Demand rate arithmetic series UGen.
dseries :: ID a => a -> UGen -> UGen -> UGen -> UGen
dseries z length_ start step = mkUGen Nothing [DR,DR] (Left DR) "Dseries" [length_,start,step] Nothing 1 (Special 0) (toUId z)

-- | Demand rate random sequence generator
dshuf :: ID a => a -> UGen -> UGen -> UGen
dshuf z repeats list_ = mkUGen Nothing [DR,DR] (Left DR) "Dshuf" [repeats] (Just list_) 1 (Special 0) (toUId z)

-- | Demand rate input replicator
dstutter :: ID a => a -> UGen -> UGen -> UGen
dstutter z n in_ = mkUGen Nothing [DR,DR] (Left DR) "Dstutter" [n,in_] Nothing 1 (Special 0) (toUId z)

-- | Demand rate generator for embedding different inputs
dswitch :: ID a => a -> UGen -> UGen -> UGen
dswitch z index_ list_ = mkUGen Nothing [DR,DR] (Left DR) "Dswitch" [index_] (Just list_) 1 (Special 0) (toUId z)

-- | Demand rate generator for switching between inputs.
dswitch1 :: ID a => a -> UGen -> UGen -> UGen
dswitch1 z index_ list_ = mkUGen Nothing [DR,DR] (Left DR) "Dswitch1" [index_] (Just list_) 1 (Special 0) (toUId z)

-- | Return the same unique series of values for several demand streams
dunique :: ID a => a -> UGen -> UGen -> UGen -> UGen
dunique z source maxBufferSize protected = mkUGen Nothing [DR,DR] (Left DR) "Dunique" [source,maxBufferSize,protected] Nothing 1 (Special 0) (toUId z)

-- | Random impulses.
dust :: ID a => a -> Rate -> UGen -> UGen
dust z rate density = mkUGen Nothing [AR,KR] (Left rate) "Dust" [density] Nothing 1 (Special 0) (toUId z)

-- | Random impulses.
dust2 :: ID a => a -> Rate -> UGen -> UGen
dust2 z rate density = mkUGen Nothing [AR,KR] (Left rate) "Dust2" [density] Nothing 1 (Special 0) (toUId z)
...
dxrand z repeats list_ = mkUGen Nothing [DR,DR] (Left DR) "Dxrand" [repeats] (Just list_) 1 (Special 0) (toUId z)

-- | Envelope generator
envGen :: Rate -> UGen -> UGen -> UGen -> UGen -> DoneAction -> Envelope UGen -> UGen
envGen rate gate_ levelScale levelBias timeScale doneAction envelope_ = mkUGen Nothing [AR,KR] (Left rate) "EnvGen" [gate_,levelScale,levelBias,timeScale,(from_done_action doneAction)] (Just (envelope_to_ugen envelope_)) 1 (Special 0) NoId
...
fos in_ a0 a1 b1 = mkUGen Nothing [AR,KR] (Right [0]) "FOS" [in_,a0,a1,b1] Nothing 1 (Special 0) NoId

-- | Fast sine oscillator.
fSinOsc :: Rate -> UGen -> UGen -> UGen
fSinOsc rate freq iphase = mkUGen Nothing [AR,KR] (Left rate) "FSinOsc" [freq,iphase] Nothing 1 (Special 0) NoId

-- | Fold a signal outside given thresholds.
fold :: UGen -> UGen -> UGen -> UGen
fold in_ lo hi = mkUGen Nothing [AR,KR,IR] (Right [0]) "Fold" [in_,lo,hi] Nothing 1 (Special 0) NoId
...
-- | Gate or hold.
gate :: UGen -> UGen -> UGen
gate in_ trig_ = mkUGen Nothing [AR,KR] (Right [0]) "Gate" [in_,trig_] Nothing 1 (Special 0) NoId
...
gendy1 z rate ampdist durdist adparam ddparam minfreq maxfreq ampscale durscale initCPs knum = mkUGen Nothing [AR,KR] (Left rate) "Gendy1" [ampdist,durdist,adparam,ddparam,minfreq,maxfreq,ampscale,durscale,initCPs,knum] Nothing 1 (Special 0) (toUId z)

-- | Dynamic stochastic synthesis generator.
gendy2 :: ID a => a -> Rate -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
gendy2 z rate ampdist durdist adparam ddparam minfreq maxfreq ampscale durscale initCPs knum a c = mkUGen Nothing [AR,KR] (Left rate) "Gendy2" [ampdist,durdist,adparam,ddparam,minfreq,maxfreq,ampscale,durscale,initCPs,knum,a,c] Nothing 1 (Special 0) (toUId z)

-- | Dynamic stochastic synthesis generator.
gendy3 :: ID a => a -> Rate -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
gendy3 z rate ampdist durdist adparam ddparam freq ampscale durscale initCPs knum = mkUGen Nothing [AR,KR] (Left rate) "Gendy3" [ampdist,durdist,adparam,ddparam,freq,ampscale,durscale,initCPs,knum] Nothing 1 (Special 0) (toUId z)

-- | Granular synthesis with sound stored in a buffer
grainBuf :: Int -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
grainBuf numChannels trigger dur sndbuf rate_ pos interp pan envbufnum maxGrains = mkUGen Nothing [AR,AR] (Left AR) "GrainBuf" [trigger,dur,sndbuf,rate_,pos,interp,pan,envbufnum,maxGrains] Nothing numChannels (Special 0) NoId

-- | Granular synthesis with frequency modulated sine tones
grainFM :: Int -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
grainFM numChannels trigger dur carfreq modfreq index_ pan envbufnum maxGrains = mkUGen Nothing [AR,AR] (Left AR) "GrainFM" [trigger,dur,carfreq,modfreq,index_,pan,envbufnum,maxGrains] Nothing numChannels (Special 0) NoId

-- | Granulate an input signal
grainIn :: Int -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
grainIn numChannels trigger dur in_ pan envbufnum maxGrains = mkUGen Nothing [AR,AR] (Left AR) "GrainIn" [trigger,dur,in_,pan,envbufnum,maxGrains] Nothing numChannels (Special 0) NoId

-- | Granular synthesis with sine tones
grainSin :: Int -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
grainSin numChannels trigger dur freq pan envbufnum maxGrains = mkUGen Nothing [AR,AR] (Left AR) "GrainSin" [trigger,dur,freq,pan,envbufnum,maxGrains] Nothing numChannels (Special 0) NoId

-- | Gray Noise.
grayNoise :: ID a => a -> Rate -> UGen
grayNoise z rate = mkUGen Nothing [AR,KR] (Left rate) "GrayNoise" [] Nothing 1 (Special 0) (toUId z)

-- | 2nd order Butterworth highpass filter.
hpf :: UGen -> UGen -> UGen
hpf in_ freq = mkUGen Nothing [AR,KR] (Right [0]) "HPF" [in_,freq] Nothing 1 (Special 0) NoId

-- | Two point difference filter
hpz1 :: UGen -> UGen
hpz1 in_ = mkUGen Nothing [AR,KR] (Right [0]) "HPZ1" [in_] Nothing 1 (Special 0) NoId

-- | Two zero fixed midcut.
hPZ2 :: UGen -> UGen
hPZ2 in_ = mkUGen Nothing [AR,KR] (Right [0]) "HPZ2" [in_] Nothing 1 (Special 0) NoId

-- | Randomized value.
hasher :: UGen -> UGen
hasher in_ = mkUGen Nothing [AR,KR] (Right [0]) "Hasher" [in_] Nothing 1 (Special 0) NoId
...
impulse rate freq phase = mkUGen Nothing [AR,KR] (Left rate) "Impulse" [freq,phase] Nothing 1 (Special 0) NoId
...
inRange in_ lo hi = mkUGen Nothing [AR,KR,IR] (Right [0]) "InRange" [in_,lo,hi] Nothing 1 (Special 0) NoId

-- | Test if a point is within a given rectangle.
inRect :: Rate -> UGen -> UGen -> UGen -> UGen
inRect rate x y rect = mkUGen Nothing [AR,KR] (Left rate) "InRect" [x,y,rect] Nothing 1 (Special 0) NoId
...
index bufnum in_ = mkUGen Nothing [AR,KR] (Right [1]) "Index" [bufnum,in_] Nothing 1 (Special 0) NoId
...
indexInBetween rate bufnum in_ = mkUGen Nothing [AR,KR] (Left rate) "IndexInBetween" [bufnum,in_] Nothing 1 (Special 0) NoId

-- | Index into a table with a signal, linear interpolated
indexL :: Rate -> UGen -> UGen -> UGen
indexL rate bufnum in_ = mkUGen Nothing [AR,KR] (Left rate) "IndexL" [bufnum,in_] Nothing 1 (Special 0) NoId
...
integrator in_ coef = mkUGen Nothing [AR,KR] (Right [0]) "Integrator" [in_,coef] Nothing 1 (Special 0) NoId

-- | Control to audio rate converter.
k2A :: UGen -> UGen
k2A in_ = mkUGen Nothing [AR,AR] (Left AR) "K2A" [in_] Nothing 1 (Special 0) NoId
...
klang rate freqoffset specificationsArrayRef freqscale = mkUGen Nothing [AR] (Left rate) "Klang" [freqoffset,specificationsArrayRef] (Just freqscale) 1 (Special 0) NoId

-- | Bank of resonators
klank :: UGen -> UGen -> UGen -> UGen -> UGen -> UGen
klank decayscale specificationsArrayRef input freqscale freqoffset = mkUGen Nothing [AR] (Right [0]) "Klank" [decayscale,specificationsArrayRef,input,freqscale] (Just freqoffset) 1 (Special 0) NoId

-- | Clipped noise
lfClipNoise :: ID a => a -> Rate -> UGen -> UGen
lfClipNoise z rate freq = mkUGen Nothing [AR,KR] (Left rate) "LFClipNoise" [freq] Nothing 1 (Special 0) (toUId z)

-- | A sine like shape made of two cubic pieces
lfCub :: Rate -> UGen -> UGen -> UGen
lfCub rate freq iphase = mkUGen Nothing [AR,KR] (Left rate) "LFCub" [freq,iphase] Nothing 1 (Special 0) NoId

-- | Dynamic clipped noise
lfdClipNoise :: ID a => a -> Rate -> UGen -> UGen
lfdClipNoise z rate freq = mkUGen Nothing [AR,KR] (Left rate) "LFDClipNoise" [freq] Nothing 1 (Special 0) (toUId z)

-- | Dynamic step noise
lfdNoise0 :: ID a => a -> Rate -> UGen -> UGen
lfdNoise0 z rate freq = mkUGen Nothing [AR,KR] (Left rate) "LFDNoise0" [freq] Nothing 1 (Special 0) (toUId z)

-- | Dynamic ramp noise
lfdNoise1 :: ID a => a -> Rate -> UGen -> UGen
lfdNoise1 z rate freq = mkUGen Nothing [AR,KR] (Left rate) "LFDNoise1" [freq] Nothing 1 (Special 0) (toUId z)

-- | Dynamic cubic noise
lfdNoise3 :: ID a => a -> Rate -> UGen -> UGen
lfdNoise3 z rate freq = mkUGen Nothing [AR,KR] (Left rate) "LFDNoise3" [freq] Nothing 1 (Special 0) (toUId z)

-- | Gaussian function oscillator
lfGauss :: Rate -> UGen -> UGen -> UGen -> Loop -> DoneAction -> UGen
lfGauss rate duration width iphase loop doneAction = mkUGen Nothing [AR,KR] (Left rate) "LFGauss" [duration,width,iphase,(from_loop loop),(from_done_action doneAction)] Nothing 1 (Special 0) NoId

-- | Step noise
lfNoise0 :: ID a => a -> Rate -> UGen -> UGen
lfNoise0 z rate freq = mkUGen Nothing [AR,KR] (Left rate) "LFNoise0" [freq] Nothing 1 (Special 0) (toUId z)

-- | Ramp noise
lfNoise1 :: ID a => a -> Rate -> UGen -> UGen
lfNoise1 z rate freq = mkUGen Nothing [AR,KR] (Left rate) "LFNoise1" [freq] Nothing 1 (Special 0) (toUId z)

-- | Quadratic noise.
lfNoise2 :: ID a => a -> Rate -> UGen -> UGen
lfNoise2 z rate freq = mkUGen Nothing [AR,KR] (Left rate) "LFNoise2" [freq] Nothing 1 (Special 0) (toUId z)

-- | Parabolic oscillator
lfPar :: Rate -> UGen -> UGen -> UGen
lfPar rate freq iphase = mkUGen Nothing [AR,KR] (Left rate) "LFPar" [freq,iphase] Nothing 1 (Special 0) NoId

-- | pulse oscillator
lfPulse :: Rate -> UGen -> UGen -> UGen -> UGen
lfPulse rate freq iphase width = mkUGen Nothing [AR,KR] (Left rate) "LFPulse" [freq,iphase,width] Nothing 1 (Special 0) NoId

-- | Sawtooth oscillator
lfSaw :: Rate -> UGen -> UGen -> UGen
lfSaw rate freq iphase = mkUGen Nothing [AR,KR] (Left rate) "LFSaw" [freq,iphase] Nothing 1 (Special 0) NoId

-- | Triangle oscillator
lfTri :: Rate -> UGen -> UGen -> UGen
lfTri rate freq iphase = mkUGen Nothing [AR,KR] (Left rate) "LFTri" [freq,iphase] Nothing 1 (Special 0) NoId
...
-- | Exponential lag
lag :: UGen -> UGen -> UGen
lag in_ lagTime = mkUGen Nothing [AR,KR] (Right [0]) "Lag" [in_,lagTime] Nothing 1 (Special 0) NoId

-- | Exponential lag
lag2 :: UGen -> UGen -> UGen
lag2 in_ lagTime = mkUGen Nothing [AR,KR] (Right [0]) "Lag2" [in_,lagTime] Nothing 1 (Special 0) NoId

-- | Exponential lag
lag2UD :: UGen -> UGen -> UGen -> UGen
lag2UD in_ lagTimeU lagTimeD = mkUGen Nothing [AR,KR] (Right [0]) "Lag2UD" [in_,lagTimeU,lagTimeD] Nothing 1 (Special 0) NoId

-- | Exponential lag
lag3 :: UGen -> UGen -> UGen
lag3 in_ lagTime = mkUGen Nothing [AR,KR] (Right [0]) "Lag3" [in_,lagTime] Nothing 1 (Special 0) NoId

-- | Exponential lag
lag3UD :: UGen -> UGen -> UGen -> UGen
lag3UD in_ lagTimeU lagTimeD = mkUGen Nothing [AR,KR] (Right [0]) "Lag3UD" [in_,lagTimeU,lagTimeD] Nothing 1 (Special 0) NoId

-- | Lagged control input
lagControl :: Rate -> UGen -> UGen -> UGen
lagControl rate values lags = mkUGen Nothing [KR,IR] (Left rate) "LagControl" [values,lags] Nothing 1 (Special 0) NoId
...
lagUD in_ lagTimeU lagTimeD = mkUGen Nothing [AR,KR] (Right [0]) "LagUD" [in_,lagTimeU,lagTimeD] Nothing 1 (Special 0) NoId

-- | Output the last value before the input changed
lastValue :: UGen -> UGen -> UGen
lastValue in_ diff = mkUGen Nothing [AR,KR] (Right [0]) "LastValue" [in_,diff] Nothing 1 (Special 0) NoId

-- | Sample and hold
latch :: UGen -> UGen -> UGen
latch in_ trig_ = mkUGen Nothing [AR,KR] (Right [0]) "Latch" [in_,trig_] Nothing 1 (Special 0) NoId
...
leakDC in_ coef = mkUGen Nothing [AR,KR] (Right [0]) "LeakDC" [in_,coef] Nothing 1 (Special 0) NoId

-- | Output least changed
leastChange :: Rate -> UGen -> UGen -> UGen
leastChange rate a b = mkUGen Nothing [AR,KR] (Left rate) "LeastChange" [a,b] Nothing 1 (Special 0) NoId
...
linExp in_ srclo srchi dstlo dsthi = mkUGen Nothing [AR,KR] (Right [0]) "LinExp" [in_,srclo,srchi,dstlo,dsthi] Nothing 1 (Special 0) NoId

-- | Two channel linear pan.
linPan2 :: UGen -> UGen -> UGen -> UGen
linPan2 in_ pos level = mkUGen Nothing [AR,KR] (Right [0]) "LinPan2" [in_,pos,level] Nothing 2 (Special 0) NoId
...
linXFade2 inA inB pan level = mkUGen Nothing [AR,KR] (Right [0,1]) "LinXFade2" [inA,inB,pan,level] Nothing 1 (Special 0) NoId

-- | Line generator.
line :: Rate -> UGen -> UGen -> UGen -> DoneAction -> UGen
line rate start end dur doneAction = mkUGen Nothing [AR,KR] (Left rate) "Line" [start,end,dur,(from_done_action doneAction)] Nothing 1 (Special 0) NoId

-- | Simple linear envelope generator.
linen :: UGen -> UGen -> UGen -> UGen -> DoneAction -> UGen
linen gate_ attackTime susLevel releaseTime doneAction = mkUGen Nothing [KR,KR] (Left KR) "Linen" [gate_,attackTime,susLevel,releaseTime,(from_done_action doneAction)] Nothing 1 (Special 0) NoId
...
localIn numChannels rate default_ = mkUGen Nothing [AR,KR] (Left rate) "LocalIn" [] (Just default_) numChannels (Special 0) NoId

-- | Write to buses local to a synth.
localOut :: UGen -> UGen
localOut input = mkUGen Nothing [AR,KR] (Right [0]) "LocalOut" [] (Just input) 1 (Special 0) NoId

-- | Chaotic noise function
logistic :: Rate -> UGen -> UGen -> UGen -> UGen
logistic rate chaosParam freq init_ = mkUGen Nothing [AR,KR] (Left rate) "Logistic" [chaosParam,freq,init_] Nothing 1 (Special 0) NoId
...
mantissaMask in_ bits = mkUGen Nothing [AR,KR] (Right [0]) "MantissaMask" [in_,bits] Nothing 1 (Special 0) NoId
...
median length_ in_ = mkUGen Nothing [AR,KR] (Right [1]) "Median" [length_,in_] Nothing 1 (Special 0) NoId

-- | Parametric filter.
midEQ :: UGen -> UGen -> UGen -> UGen -> UGen
midEQ in_ freq rq db = mkUGen Nothing [AR,KR] (Right [0]) "MidEQ" [in_,freq,rq,db] Nothing 1 (Special 0) NoId

-- | Minimum difference of two values in modulo arithmetics
modDif :: Rate -> UGen -> UGen -> UGen -> UGen
modDif rate x y mod_ = mkUGen Nothing [AR,KR,IR] (Left rate) "ModDif" [x,y,mod_] Nothing 1 (Special 0) NoId

-- | Moog VCF implementation, designed by Federico Fontana
moogFF :: UGen -> UGen -> UGen -> UGen -> UGen
moogFF in_ freq gain reset = mkUGen Nothing [AR,KR] (Right [0]) "MoogFF" [in_,freq,gain,reset] Nothing 1 (Special 0) NoId

-- | Output most changed.
mostChange :: UGen -> UGen -> UGen
mostChange a b = mkUGen Nothing [AR,KR] (Right [0,1]) "MostChange" [a,b] Nothing 1 (Special 0) NoId
...
numAudioBuses :: UGen
numAudioBuses = mkUGen Nothing [IR,IR] (Left IR) "NumAudioBuses" [] Nothing 1 (Special 0) NoId

-- | Number of open buffers.
numBuffers :: UGen
numBuffers = mkUGen Nothing [IR,IR] (Left IR) "NumBuffers" [] Nothing 1 (Special 0) NoId

-- | Number of control busses.
numControlBuses :: UGen
numControlBuses = mkUGen Nothing [IR,IR] (Left IR) "NumControlBuses" [] Nothing 1 (Special 0) NoId

-- | Number of input busses.
numInputBuses :: UGen
numInputBuses = mkUGen Nothing [IR,IR] (Left IR) "NumInputBuses" [] Nothing 1 (Special 0) NoId

-- | Number of output busses.
numOutputBuses :: UGen
numOutputBuses = mkUGen Nothing [IR,IR] (Left IR) "NumOutputBuses" [] Nothing 1 (Special 0) NoId

-- | Number of currently running synths.
numRunningSynths :: UGen
numRunningSynths = mkUGen Nothing [KR,IR,IR] (Left IR) "NumRunningSynths" [] Nothing 1 (Special 0) NoId

-- | Write a signal to a bus with sample accurate timing.
offsetOut :: UGen -> UGen -> UGen
offsetOut bus input = mkUGen Nothing [AR,KR] (Right [1]) "OffsetOut" [bus] (Just input) 1 (Special 0) NoId

-- | One pole filter.
onePole :: UGen -> UGen -> UGen
onePole in_ coef = mkUGen Nothing [AR,KR] (Right [0]) "OnePole" [in_,coef] Nothing 1 (Special 0) NoId

-- | One zero filter.
oneZero :: UGen -> UGen -> UGen
oneZero in_ coef = mkUGen Nothing [AR,KR] (Right [0]) "OneZero" [in_,coef] Nothing 1 (Special 0) NoId

-- | Onset detector
onsets :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
onsets rate chain threshold odftype relaxtime floor_ mingap medianspan whtype rawodf = mkUGen Nothing [KR] (Left rate) "Onsets" [chain,threshold,odftype,relaxtime,floor_,mingap,medianspan,whtype,rawodf] Nothing 1 (Special 0) NoId

-- | Interpolating wavetable oscillator.
osc :: Rate -> UGen -> UGen -> UGen -> UGen
osc rate bufnum freq phase = mkUGen Nothing [AR,KR] (Left rate) "Osc" [bufnum,freq,phase] Nothing 1 (Special 0) NoId

-- | Noninterpolating wavetable oscillator.
oscN :: Rate -> UGen -> UGen -> UGen -> UGen
oscN rate bufnum freq phase = mkUGen Nothing [AR,KR] (Left rate) "OscN" [bufnum,freq,phase] Nothing 1 (Special 0) NoId

-- | Write a signal to a bus.
out :: UGen -> UGen -> UGen
out bus input = mkUGen Nothing [AR,KR] (Right [1]) "Out" [bus] (Just input) 1 (Special 0) NoId
...
pan2 in_ pos level = mkUGen Nothing [AR,KR] (Right [0]) "Pan2" [in_,pos,level] Nothing 2 (Special 0) NoId
...
panB rate in_ azimuth elevation gain = mkUGen Nothing [AR,KR] (Left rate) "PanB" [in_,azimuth,elevation,gain] Nothing 4 (Special 0) NoId

-- | 2D Ambisonic B-format panner.
panB2 :: Rate -> UGen -> UGen -> UGen -> UGen
panB2 rate in_ azimuth gain = mkUGen Nothing [AR,KR] (Left rate) "PanB2" [in_,azimuth,gain] Nothing 3 (Special 0) NoId

-- | Real-time partitioned convolution
partConv :: Rate -> UGen -> UGen -> UGen -> UGen
partConv rate in_ fftsize irbufnum = mkUGen Nothing [AR] (Left rate) "PartConv" [in_,fftsize,irbufnum] Nothing 1 (Special 0) NoId
...
peak :: UGen -> UGen -> UGen
peak in_ trig_ = mkUGen Nothing [AR,KR] (Right [0]) "Peak" [in_,trig_] Nothing 1 (Special 0) NoId

-- | Track peak signal amplitude.
peakFollower :: UGen -> UGen -> UGen
peakFollower in_ decay_ = mkUGen Nothing [AR,KR] (Right [0]) "PeakFollower" [in_,decay_] Nothing 1 (Special 0) NoId

-- | A resettable linear ramp between two levels.
phasor :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
phasor rate trig_ rate_ start end resetPos = mkUGen Nothing [AR,KR] (Left rate) "Phasor" [trig_,rate_,start,end,resetPos] Nothing 1 (Special 0) NoId

-- | Pink Noise.
pinkNoise :: ID a => a -> Rate -> UGen
pinkNoise z rate = mkUGen Nothing [AR,KR] (Left rate) "PinkNoise" [] Nothing 1 (Special 0) (toUId z)

-- | Autocorrelation pitch follower
pitch :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
pitch rate in_ initFreq minFreq maxFreq execFreq maxBinsPerOctave median_ ampThreshold peakThreshold downSample clar = mkUGen Nothing [KR] (Left rate) "Pitch" [in_,initFreq,minFreq,maxFreq,execFreq,maxBinsPerOctave,median_,ampThreshold,peakThreshold,downSample,clar] Nothing 2 (Special 0) NoId
...
playBuf numChannels rate bufnum rate_ trigger startPos loop doneAction = mkUGen Nothing [AR,KR] (Left rate) "PlayBuf" [bufnum,rate_,trigger,startPos,(from_loop loop),(from_done_action doneAction)] Nothing numChannels (Special 0) NoId
...
pulse rate freq width = mkUGen Nothing [AR,KR] (Left rate) "Pulse" [freq,width] Nothing 1 (Special 0) NoId

-- | Pulse counter.
pulseCount :: UGen -> UGen -> UGen
pulseCount trig_ reset = mkUGen Nothing [AR,KR] (Right [0]) "PulseCount" [trig_,reset] Nothing 1 (Special 0) NoId

-- | Pulse divider.
pulseDivider :: UGen -> UGen -> UGen -> UGen
pulseDivider trig_ div_ start = mkUGen Nothing [AR,KR] (Right [0]) "PulseDivider" [trig_,div_,start] Nothing 1 (Special 0) NoId
...
rDelayMap rate bufnum in_ dynamic spec = mkUGen Nothing [AR,KR] (Left rate) "RDelayMap" [bufnum,in_,dynamic,spec] Nothing 1 (Special 0) NoId

-- | (Undocumented class)
rDelaySet :: Rate -> UGen -> UGen -> UGen
rDelaySet rate in_ spec = mkUGen Nothing [AR,KR] (Left rate) "RDelaySet" [in_,spec] Nothing 1 (Special 0) NoId

-- | (Undocumented class)
rDelaySetB :: Rate -> UGen -> UGen -> UGen -> UGen
rDelaySetB rate bufnum in_ spec = mkUGen Nothing [AR,KR] (Left rate) "RDelaySetB" [bufnum,in_,spec] Nothing 1 (Special 0) NoId

-- | (Undocumented class)
rFreezer :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
rFreezer rate bufnum left right gain increment incrementOffset incrementRandom rightRandom syncPhaseTrigger randomizePhaseTrigger numberOfLoops = mkUGen Nothing [AR,KR] (Left rate) "RFreezer" [bufnum,left,right,gain,increment,incrementOffset,incrementRandom,rightRandom,syncPhaseTrigger,randomizePhaseTrigger,numberOfLoops] Nothing 1 (Special 0) NoId

-- | A resonant high pass filter.
rhpf :: UGen -> UGen -> UGen -> UGen
rhpf in_ freq rq = mkUGen Nothing [AR,KR] (Right [0]) "RHPF" [in_,freq,rq] Nothing 1 (Special 0) NoId

-- | A resonant low pass filter.
rlpf :: UGen -> UGen -> UGen -> UGen
rlpf in_ freq rq = mkUGen Nothing [AR,KR] (Right [0]) "RLPF" [in_,freq,rq] Nothing 1 (Special 0) NoId

-- | (Undocumented class)
rLoopSet :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
rLoopSet rate bufnum left right gain increment spec = mkUGen Nothing [AR,KR] (Left rate) "RLoopSet" [bufnum,left,right,gain,increment,spec] Nothing 1 (Special 0) NoId

-- | (Undocumented class)
rPlayTrace :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen
rPlayTrace rate bufnum degree rate_ axis = mkUGen Nothing [AR,KR] (Left rate) "RPlayTrace" [bufnum,degree,rate_,axis] Nothing 1 (Special 0) NoId
...
rShufflerL rate in_ fragmentSize maxDelay = mkUGen Nothing [AR,KR] (Left rate) "RShufflerL" [in_,fragmentSize,maxDelay] Nothing 1 (Special 0) NoId

-- | (Undocumented class)
rTraceRd :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen
rTraceRd rate bufnum degree index_ axis = mkUGen Nothing [AR,KR] (Left rate) "RTraceRd" [bufnum,degree,index_,axis] Nothing 1 (Special 0) NoId
...
radiansPerSample = mkUGen Nothing [IR,IR] (Left IR) "RadiansPerSample" [] Nothing 1 (Special 0) NoId

-- | Break a continuous signal into line segments
ramp :: UGen -> UGen -> UGen
ramp in_ lagTime = mkUGen Nothing [AR,KR] (Right [0]) "Ramp" [in_,lagTime] Nothing 1 (Special 0) NoId
...
randID rate id_ = mkUGen Nothing [KR,IR] (Left rate) "RandID" [id_] Nothing 1 (Special 0) NoId

-- | Sets the synth's random generator seed.
randSeed :: Rate -> UGen -> UGen -> UGen
randSeed rate trig_ seed = mkUGen Nothing [AR,KR,IR] (Left rate) "RandSeed" [trig_,seed] Nothing 1 (Special 0) NoId

-- | Record or overdub into a Buffer.
recordBuf :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen -> Loop -> UGen -> DoneAction -> UGen -> UGen
recordBuf rate doneAction inputArray bufnum offset recLevel preLevel run loop trigger = mkUGen Nothing [AR,KR] (Left rate) "RecordBuf" [doneAction,inputArray,bufnum,offset,recLevel,(from_loop preLevel),run,(from_done_action loop)] (Just trigger) 1 (Special 0) NoId

-- | Send signal to a bus, overwriting previous contents.
replaceOut :: UGen -> UGen -> UGen
replaceOut bus input = mkUGen Nothing [AR,KR] (Right [1]) "ReplaceOut" [bus] (Just input) 1 (Special 0) NoId

-- | Resonant filter.
resonz :: UGen -> UGen -> UGen -> UGen
resonz in_ freq bwr = mkUGen Nothing [AR,KR] (Right [0]) "Resonz" [in_,freq,bwr] Nothing 1 (Special 0) NoId

-- | Ringing filter.
ringz :: UGen -> UGen -> UGen -> UGen
ringz in_ freq decaytime = mkUGen Nothing [AR,KR] (Right [0]) "Ringz" [in_,freq,decaytime] Nothing 1 (Special 0) NoId

-- | Rotate a sound field.
rotate2 :: UGen -> UGen -> UGen -> UGen
rotate2 x y pos = mkUGen Nothing [AR,KR] (Right [0,1]) "Rotate2" [x,y,pos] Nothing 2 (Special 0) NoId

-- | Track maximum level.
runningMax :: UGen -> UGen -> UGen
runningMax in_ trig_ = mkUGen Nothing [AR,KR] (Right [0]) "RunningMax" [in_,trig_] Nothing 1 (Special 0) NoId

-- | Track minimum level.
runningMin :: UGen -> UGen -> UGen
runningMin in_ trig_ = mkUGen Nothing [AR,KR] (Right [0]) "RunningMin" [in_,trig_] Nothing 1 (Special 0) NoId

-- | Running sum over n frames
runningSum :: UGen -> UGen -> UGen
runningSum in_ numsamp = mkUGen Nothing [AR,KR] (Right [0]) "RunningSum" [in_,numsamp] Nothing 1 (Special 0) NoId

-- | Second order filter section (biquad).
sos :: UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
sos in_ a0 a1 a2 b1 b2 = mkUGen Nothing [AR,KR] (Right [0]) "SOS" [in_,a0,a1,a2,b1,b2] Nothing 1 (Special 0) NoId

-- | Duration of one sample.
sampleDur :: UGen
sampleDur = mkUGen Nothing [IR,IR] (Left IR) "SampleDur" [] Nothing 1 (Special 0) NoId

-- | Server sample rate.
sampleRate :: UGen
sampleRate = mkUGen Nothing [IR,IR] (Left IR) "SampleRate" [] Nothing 1 (Special 0) NoId

-- | Band limited sawtooth.
saw :: Rate -> UGen -> UGen
saw rate freq = mkUGen Nothing [AR,KR] (Left rate) "Saw" [freq] Nothing 1 (Special 0) NoId

-- | Schmidt trigger.
schmidt :: Rate -> UGen -> UGen -> UGen -> UGen
schmidt rate in_ lo hi = mkUGen Nothing [AR,KR,IR] (Left rate) "Schmidt" [in_,lo,hi] Nothing 1 (Special 0) NoId

-- | FIXME: ScopeOut purpose.
scopeOut :: Rate -> UGen -> UGen -> UGen
scopeOut rate inputArray bufnum = mkUGen Nothing [AR,KR] (Left rate) "ScopeOut" [inputArray,bufnum] Nothing 1 (Special 0) NoId

-- | (Undocumented class)
scopeOut2 :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen
scopeOut2 rate inputArray scopeNum maxFrames scopeFrames = mkUGen Nothing [AR,KR] (Left rate) "ScopeOut2" [inputArray,scopeNum,maxFrames,scopeFrames] Nothing 1 (Special 0) NoId
...
sendTrig in_ id_ value = mkUGen Nothing [AR,KR] (Right [0]) "SendTrig" [in_,id_,value] Nothing 1 (Special 0) NoId

-- | Set-reset flip flop.
setResetFF :: UGen -> UGen -> UGen
setResetFF trig_ reset = mkUGen Nothing [AR,KR] (Right [0]) "SetResetFF" [trig_,reset] Nothing 1 (Special 0) NoId

-- | Wave shaper.
shaper :: UGen -> UGen -> UGen
shaper bufnum in_ = mkUGen Nothing [AR,KR] (Right [1]) "Shaper" [bufnum,in_] Nothing 1 (Special 0) NoId

-- | Interpolating sine wavetable oscillator.
sinOsc :: Rate -> UGen -> UGen -> UGen
sinOsc rate freq phase = mkUGen Nothing [AR,KR] (Left rate) "SinOsc" [freq,phase] Nothing 1 (Special 0) NoId

-- | Feedback FM oscillator
sinOscFB :: Rate -> UGen -> UGen -> UGen
sinOscFB rate freq feedback = mkUGen Nothing [AR,KR] (Left rate) "SinOscFB" [freq,feedback] Nothing 1 (Special 0) NoId

-- | Slew rate limiter.
slew :: UGen -> UGen -> UGen -> UGen
slew in_ up dn = mkUGen Nothing [AR,KR] (Right [0]) "Slew" [in_,up,dn] Nothing 1 (Special 0) NoId

-- | Slope of signal
slope :: UGen -> UGen
slope in_ = mkUGen Nothing [AR,KR] (Right [0]) "Slope" [in_] Nothing 1 (Special 0) NoId
...
spring rate in_ spring_ damp = mkUGen Nothing [AR,KR] (Left rate) "Spring" [in_,spring_,damp] Nothing 1 (Special 0) NoId
...
stepper trig_ reset min_ max_ step resetval = mkUGen Nothing [AR,KR] (Right [0]) "Stepper" [trig_,reset,min_,max_,step,resetval] Nothing 1 (Special 0) NoId
...
subsampleOffset = mkUGen Nothing [IR,IR] (Left IR) "SubsampleOffset" [] Nothing 1 (Special 0) NoId
...
sweep trig_ rate_ = mkUGen Nothing [AR,KR] (Right [0]) "Sweep" [trig_,rate_] Nothing 1 (Special 0) NoId
...
tBall rate in_ g damp friction = mkUGen Nothing [AR,KR] (Left rate) "TBall" [in_,g,damp,friction] Nothing 1 (Special 0) NoId

-- | Trigger delay.
tDelay :: UGen -> UGen -> UGen
tDelay in_ dur = mkUGen Nothing [AR,KR] (Right [0]) "TDelay" [in_,dur] Nothing 1 (Special 0) NoId

-- | Demand results as trigger from demand rate UGens.
tDuty :: Rate -> UGen -> UGen -> DoneAction -> UGen -> UGen -> UGen
tDuty rate dur reset doneAction level gapFirst = mkUGen Nothing [AR,KR] (Left rate) "TDuty" [dur,reset,(from_done_action doneAction),level,gapFirst] Nothing 1 (Special 0) NoId
...
tIRand z lo hi trig_ = mkUGen Nothing [AR,KR] (Right [2]) "TIRand" [lo,hi,trig_] Nothing 1 (Special 0) (toUId z)

-- | Triggered random number generator.
tRand :: ID a => a -> UGen -> UGen -> UGen -> UGen
tRand z lo hi trig_ = mkUGen Nothing [AR,KR] (Right [2]) "TRand" [lo,hi,trig_] Nothing 1 (Special 0) (toUId z)

-- | Triggered windex.
tWindex :: ID a => a -> UGen -> UGen -> UGen -> UGen
tWindex z in_ normalize array = mkUGen Nothing [AR,KR] (Right [0]) "TWindex" [in_,normalize] (Just array) 1 (Special 0) (toUId z)
...
timer :: UGen -> UGen
timer trig_ = mkUGen Nothing [AR,KR] (Right [0]) "Timer" [trig_] Nothing 1 (Special 0) NoId

-- | Toggle flip flop.
toggleFF :: UGen -> UGen
toggleFF trig_ = mkUGen Nothing [AR,KR] (Right [0]) "ToggleFF" [trig_] Nothing 1 (Special 0) NoId

-- | Timed trigger.
trig :: UGen -> UGen -> UGen
trig in_ dur = mkUGen Nothing [AR,KR] (Right [0]) "Trig" [in_,dur] Nothing 1 (Special 0) NoId

-- | Timed trigger.
trig1 :: UGen -> UGen -> UGen
trig1 in_ dur = mkUGen Nothing [AR,KR] (Right [0]) "Trig1" [in_,dur] Nothing 1 (Special 0) NoId

-- | FIXME: TrigControl purpose.
trigControl :: Rate -> UGen -> UGen
trigControl rate values = mkUGen Nothing [KR,IR] (Left rate) "TrigControl" [values] Nothing 1 (Special 0) NoId

-- | Two pole filter.
twoPole :: UGen -> UGen -> UGen -> UGen
twoPole in_ freq radius = mkUGen Nothing [AR,KR] (Right [0]) "TwoPole" [in_,freq,radius] Nothing 1 (Special 0) NoId

-- | Two zero filter.
twoZero :: UGen -> UGen -> UGen -> UGen
twoZero in_ freq radius = mkUGen Nothing [AR,KR] (Right [0]) "TwoZero" [in_,freq,radius] Nothing 1 (Special 0) NoId
...
vDiskIn :: Int -> Rate -> UGen -> UGen -> Loop -> UGen -> UGen
vDiskIn numChannels rate bufnum rate_ loop sendID = mkUGen Nothing [AR] (Left rate) "VDiskIn" [bufnum,rate_,(from_loop loop),sendID] Nothing numChannels (Special 0) NoId

-- | Variable wavetable oscillator.
vOsc :: Rate -> UGen -> UGen -> UGen -> UGen
vOsc rate bufpos freq phase = mkUGen Nothing [AR,KR] (Left rate) "VOsc" [bufpos,freq,phase] Nothing 1 (Special 0) NoId

-- | Three variable wavetable oscillators.
vOsc3 :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen
vOsc3 rate bufpos freq1 freq2 freq3 = mkUGen Nothing [AR,KR] (Left rate) "VOsc3" [bufpos,freq1,freq2,freq3] Nothing 1 (Special 0) NoId

-- | Variable shaped lag
varLag :: Rate -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
varLag rate in_ time curvature warp start = mkUGen Nothing [AR,KR] (Left rate) "VarLag" [in_,time,curvature,warp,start] Nothing 1 (Special 0) NoId

-- | Variable duty saw
varSaw :: Rate -> UGen -> UGen -> UGen -> UGen
varSaw rate freq iphase width = mkUGen Nothing [AR,KR] (Left rate) "VarSaw" [freq,iphase,width] Nothing 1 (Special 0) NoId
...
vibrato z rate freq rate_ depth delay onset rateVariation depthVariation iphase = mkUGen Nothing [AR,KR] (Left rate) "Vibrato" [freq,rate_,depth,delay,onset,rateVariation,depthVariation,iphase] Nothing 1 (Special 0) (toUId z)

-- | Warp a buffer with a time pointer
warp1 :: Int -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen -> UGen
warp1 numChannels bufnum pointer freqScale windowSize envbufnum overlaps windowRandRatio interp = mkUGen Nothing [AR,AR] (Left AR) "Warp1" [bufnum,pointer,freqScale,windowSize,envbufnum,overlaps,windowRandRatio,interp] Nothing numChannels (Special 0) NoId

-- | White noise.
whiteNoise :: ID a => a -> Rate -> UGen
whiteNoise z rate = mkUGen Nothing [AR,KR] (Left rate) "WhiteNoise" [] Nothing 1 (Special 0) (toUId z)
...
wrap in_ lo hi = mkUGen Nothing [AR,KR,IR] (Right [0]) "Wrap" [in_,lo,hi] Nothing 1 (Special 0) NoId

-- | Index into a table with a signal.
wrapIndex :: UGen -> UGen -> UGen
wrapIndex bufnum in_ = mkUGen Nothing [AR,KR] (Right [1]) "WrapIndex" [bufnum,in_] Nothing 1 (Special 0) NoId

-- | Equal power two channel cross fade.
xFade2 :: UGen -> UGen -> UGen -> UGen -> UGen
xFade2 inA inB pan level = mkUGen Nothing [AR,KR] (Right [0,1]) "XFade2" [inA,inB,pan,level] Nothing 1 (Special 0) NoId

-- | Exponential line generator.
xLine :: Rate -> UGen -> UGen -> UGen -> DoneAction -> UGen
xLine rate start end dur doneAction = mkUGen Nothing [AR,KR] (Left rate) "XLine" [start,end,dur,(from_done_action doneAction)] Nothing 1 (Special 0) NoId

-- | Send signal to a bus, crossfading with previous contents.
xOut :: UGen -> UGen -> UGen -> UGen
xOut bus xfade input = mkUGen Nothing [AR,KR] (Right [2]) "XOut" [bus,xfade] (Just input) 1 (Special 0) NoId

-- | Zero crossing frequency follower
zeroCrossing :: Rate -> UGen -> UGen
zeroCrossing rate in_ = mkUGen Nothing [AR,KR] (Left rate) "ZeroCrossing" [in_] Nothing 1 (Special 0) NoId
