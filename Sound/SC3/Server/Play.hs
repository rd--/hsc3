...
--import Sound.OpenSoundControl.UDP (UDP, udp, send, wait, withUDP)
import Sound.OpenSoundControl.TCP (TCP, tcp, send, wait, withTCP)
...
withSC3 :: (TCP -> IO a) -> IO a
withSC3 = withTCP (tcp "127.0.0.1" 57110)
